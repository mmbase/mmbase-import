...
public class Poster {
     ...
     * @return <code>true</code> if the thread was viewed by this poster, <code>false</code> if it wasn't. Also
     *         returns <code>false</code> if the postthread contains new post(s) since the poster last viewed this
     *         thread.
     */
    ...
    public void readRemoteHosts() {
        ...
        while (i.hasNext()) {
            ...
            RemoteHost rm = new RemoteHost(this, rnode.getStringValue("host"), rnode.getIntValue("lastupdatetime"), rnode
                    .getIntValue("updatecount"));
    ...
    public String filterEmail(String body, PostThread t) {
        ...
        obj.replace("$url", hostpart + "thread.jsp?forumid=" + t.getParent().getParent().getId() + "&postareaid=" + t.getParent().getId()
                + "&postthreadid=" + t.getId() + "&postingid=" + t.getLastPostNumber() + "#p" + t.getLastPostNumber());
        return obj.toString();
    }
