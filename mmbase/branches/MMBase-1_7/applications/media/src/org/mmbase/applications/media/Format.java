 ...
 * @version $Id: Format.java,v 1.12.2.3 2006-01-13 12:37:41 johannes Exp $
 * @since MMBase-1.7
 */
...
public final class Format {   // final class!!
    ...
    public static List getMediaFormats() {
        return Arrays.asList(new Format[] {MP3, RA, RA,WAV, PCM, MP2, RM, VOB, AVI, MPEG, MP4, MPG, ASF, MOV, WMA, OGG, OGM, RAM, WMP, QT, PODCAST, VODCAST, M4A, M4V, GGP});
    }
