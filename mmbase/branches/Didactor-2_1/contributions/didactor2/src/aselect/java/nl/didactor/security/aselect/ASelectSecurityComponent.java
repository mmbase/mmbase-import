    ...
    public String getLoginPage(HttpServletRequest request, HttpServletResponse response) {
      ...
      public UserContext isLoggedIn(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
    	    if (verify_ticket(request, response, "a-select")) {
                ...
                if (user == null) {
                    try {
                        ...
                        response.getWriter().println("The authorization passed, but user with id=<b>" + userName + "</b> is NOT present in Didactor's database<br/>");
            ...
            throw new SecurityException("Exception during verify_ticket: " + e.getMessage(), null);
        } 
        return null;
    }
