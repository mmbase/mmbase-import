...
<body>
    <div id="houder">
        ...
        <div id="extra1">           
            <cmsc:insert-portlet layoutid="midden1" />
            <cmsc:insert-portlet layoutid="midden2" />
            <cmsc:insert-portlet layoutid="midden3" />
            <cmsc:insert-portlet layoutid="midden4" />
            <cmsc:insert-portlet layoutid="midden5" />
            <cmsc:insert-portlet layoutid="midden6" />
        </div><!-- /#extra1-->
