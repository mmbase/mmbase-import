<%--
 this works, but has still to be cleaned up.
--%>
...
<mm:import id="insrelWhereClause">(<%=insrelField1%>=<mm:field referid="this_node_number" />) and (rnumber=<%=rnumber%>)</mm:import>
...
<% if(insrelNode.getNodeValue(insrelField2).getNodeManager().getName().equals(otherNodeType.getName())) { %>
<tr>
    <%-- skip first field --%>
    <td>&nbsp;</td>
    <td class="data">
    ...
    <%  String destinationNodeNumber = insrelNode.getStringValue(insrelField2); %>
