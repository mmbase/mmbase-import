...
public class HttpAuth {
    ...
    public static String checkUser(String mimeline) {
        if(log.isDebugEnabled()) log.debug("checkUser("+mimeline+")");
     ...
     */
    public static String getAuthorization(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse res,String server, String level) 
        throws AuthorizationException, NotLoggedInException {    

        if(log.isDebugEnabled()) log.debug("getAuthorization("+req+","+res+","+server+","+level+")");
        ...
        if(remoteAuthenticationHost == null) {
            // this branch is used when authentication is done locally on this machine

            if (log.isDebugEnabled()) log.debug("use local validation");
            ...
            try {
                // this branch is used when authentication is done by an external server

                if (log.isDebugEnabled()) log.debug("use remote validation");
    ...
    public static void setLocalCheckUrl(String url) {
        if(log.isDebugEnabled()) log.trace("setLocalUrl("+url+")");
        ...
        // print resulting host and page in log
        if(log.isDebugEnabled()) log.trace("setLocalUrl("+url+"): remoteAuthenticationHost("+remoteAuthenticationHost+"), remoteAuthenticationPage("+remoteAuthenticationPage+")");
    }
