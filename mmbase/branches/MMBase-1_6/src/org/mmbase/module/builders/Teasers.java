...
public class Teasers extends MMObjectBuilder {
     ...
     * @javadoc
     * @vpro
     * @bad-literal value of state should be set/determined using constants
     */
    ...
    /**
     * @javadoc
     * @vpro '6' as image otype
     * @bad-literal image otype, image size
     */
    ...
    public boolean nodeLocalChanged(String machine, String number,String builder,String ctype) {
        ...
        if (builder.equals(tableName)) {
            ...
            if (jumpers==null) {
                log.debug("Could not get Jumper builder");
            } else {
