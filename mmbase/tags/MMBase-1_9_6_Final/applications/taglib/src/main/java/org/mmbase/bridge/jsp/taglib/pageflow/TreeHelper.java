...
public class TreeHelper {
     ...
     */
    String findLeafFile(String includePage, String objectlist, HttpSession session) throws JspTagException, IOException {
    ...
    public String findTreeFile(String includePage, String objectlist, HttpSession session) throws JspTagException, IOException {
        ...
        for (int i = 0; i < numberTokens; i++) {
            ...
            if (log.isDebugEnabled()) {
                log.debug("Found smartpath for " + objectNo + " " + field);
            }
    ...
    private String getVersion(Node n, HttpSession session) throws JspTagException {
        ...
        String versionnumber = (String)session.getAttribute(getBuilderName(n) + "version");
        if (versionnumber == null) {
