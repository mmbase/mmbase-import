...
//
// $Id: context-menu.js,v 1.1.2.1 2009-03-16 11:10:00 raintang Exp $
...
ContextMenu.prototype.popupMenu = function(ev) {
	...
	var target = HTMLArea.is_ie ? ev.srcElement : ev.target;
     var ifpos = getPos(self.editor._iframe);//_htmlArea);
	 var editform = document.getElementById("editform");
	var x = ev.clientX + ifpos.x - editform.scrollLeft;
	var y = ev.clientY + ifpos.y - editform.scrollTop;
