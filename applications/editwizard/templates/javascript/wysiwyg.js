 ...
 *
 * @since    MMBase-1.6
 * @version  $Id: wysiwyg.js,v 1.8.2.1 2003-03-05 11:46:35 pierre Exp $
 * @author   Kars Veling
 */
        ...
        for (var j=0; j<forms[i].elements.length; j++) {
            ...
            switch (el.type.toLowerCase()) {
                case "textarea":
                    ...
                    var s = "font-family:"+el.currentStyle.fontFamily+";font-size:"+el.currentStyle.fontSize+";background-color:"+el.currentStyle.backgroundColor+";";
