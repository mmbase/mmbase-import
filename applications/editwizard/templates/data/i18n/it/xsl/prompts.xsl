...
<!--
  ...
  @version $Id: prompts.xsl,v 1.4.2.1 2004-05-02 15:03:13 nico Exp $
-->
...
<xsl:template name="prompt_result_count" ><xsl:value-of select="/list/@count" /> items trovati</xsl:template>
