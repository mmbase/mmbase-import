    ...
    <table cellpadding="0" width="150">
        <tr>
            <td>
                ...
                <tr>
                    <th><mm:write referid="mlg.Folder" /></th>
                </tr>
                <mm:node referid="posterid">
                    <mm:related path="posmboxrel,forummessagebox">
                        <mm:node element="forummessagebox">
                            ...
                            <tr>
                                <td>
                                    <a href="<mm:url page="privatemessages.jsp" referids="forumid,mailboxid"><mm:param name="mailboxid"><mm:field name="number" /></mm:param></mm:url>"><mm:field name="name" /></a> (<mm:relatednodes type="forumprivatemessage"><mm:last><mm:size /></mm:last></mm:relatednodes>)
                                </td>
                            </tr>
                        </mm:node>
                    </mm:related>
    ...
    <tr>
        ...
        <form action="<mm:url page="privatemessages.jsp" referids="forumid,mailboxid" />" METHOD="POST">
            ...
            <table cellpadding="0" class="list" style="margin-top : 20px;" cellspacing="0" width="150">
                <tr>
                    <th><mm:write referid="mlg.Add_folder" /></th>
                </tr>
                <tr>
                    <td><input name="newfolder" style="width: 98%" /></td>
                </tr>
            </table>
            <%--end table addfolder--%>
    </form>
    ...
    <tr><td>
       ...
       <%--table messages--%>
        <table cellpadding="0" class="list" style="margin-top : 2px;" cellspacing="0" width="100%" border="1">
            <tr>
                <th></th><th><mm:write referid="mlg.Subject" /></th>
                <th><mm:write referid="mlg.Sender" /></th>
                <th><mm:write referid="mlg.Date" /></th>
                <th></th>
            </tr>
            <mm:compare referid="mailboxid" value="" inverse="true">
            <mm:link page="privatemessagesconfirmaction.jsp" referids="forumid,mailboxid" >
                    ...
                    <mm:node referid="mailboxid">
                        <mm:relatednodes type="forumprivatemessage" orderby="createtime" directions="down">
                            ...
                            <tr>
                                <td><mm:index /></td>
                                <td width="50%">
                                    <mm:link page="privatemessage.jsp" referids="forumid,mailboxid">
                                        <mm:param name="messageid"><mm:field name="number" /></mm:param>
                                        <a href="${_}"><mm:field name="subject" /></a>
                                        <mm:field name="viewstate">
                                            <mm:compare value="0">*<mm:write referid="mlg.UNSEEN" />*</mm:compare>
                                        </mm:field>
                                    </mm:link>
                                </td>
                                <%--
                                <td width="25%" ><mm:field name="poster" /> (<mm:field name="fullname" />)</td><td width="25%"><mm:field name="createtime"><mm:time format="d MMMM, yyyy, HH:mm:ss" /></mm:field></td>
                                --%>
                                <td width="25%" ><mm:nodefunction set="mmbob" name="getPosterInfo" referids="forumid,posterid"><mm:field name="identifier" /></mm:nodefunction></td>
                                <td width="25%"><mm:field name="createtime"><mm:time format="d MMMM, yyyy, HH:mm:ss" /></mm:field></td>
                                <td><input type="checkbox" name="selectedmessages"></td>
                            </tr>
                        </mm:relatednodes>
                    </mm:node>
                <tr>
