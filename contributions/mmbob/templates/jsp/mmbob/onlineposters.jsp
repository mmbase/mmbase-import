...
<table cellpadding="0" cellspacing="0" class="list" style="margin-top : 20px;" width="90%">
    ...
    <mm:nodelistfunction set="mmbob" name="getPostersOnline" referids="forumid" id="p">
        <tr>
            <td>
                <%--
                <a href="profile.jsp?forumid=<mm:write referid="forumid" />&posterid=<mm:field name="id" />&pathtype=onlineposters_poster"><mm:field name="firstname" /> <mm:field name="lastname" /> (<mm:field name="nick" />)</a>
                --%>
                <c:choose>
