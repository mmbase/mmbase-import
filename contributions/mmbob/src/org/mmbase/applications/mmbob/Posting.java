...
public class Posting {
     ...
     * 
     * meaning this will be decoded with BBCodes, Urls, Security checks.. needs a better caching system that doesn't
     * take memory again, probably some flipper system that either the decoded or encoded is caches depending on use.
     * 
     * @param imagecontext The context where to find the images (eg smilies)
     * @return body of this posting
     */
    ...
    private String translateBody(String body, String imagecontext) {
        ...
        try {
            ...
            transformer.transform(new javax.xml.transform.stream.StreamSource(new StringReader(body)),
