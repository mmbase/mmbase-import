 ...
 *
 * @version $Id: MMBaseServlet.java,v 1.53.2.6 2007-07-24 16:19:50 michiel Exp $
...
public class MMBaseServlet extends  HttpServlet implements MMBaseStarter {
    ...
    public static String getBasePath(String function) {
        List ls = MMBaseServlet.getServletMappingsByAssociation(function);
        if (ls.size() == 0) return null;
        String baseUrl = (String) ls.get(0);
